...
<div class="projects-section">
  ...
  <div class="project">
    <div class="project-title">Sprklii</div>
  ...
  <div class="project">
    <div class="project-title">Archimedes</div>
    <div class="project-description">
  ...
  <div class="project">
    <div class="project-title">CS50</div>
    <div class="project-description">
...
|-----------------------------|---------------------------------------------------------------|-------------------------------------------------|
| Website Creation             | Create Website in Markdown with some HRML                     | Markdown, Obsidian                              |
...
Group - Team of Four: Focused  on UI + dictation work.
